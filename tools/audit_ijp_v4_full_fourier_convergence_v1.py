...
format.  Every trial uses the released V3 singular input and metric.
"""
...
def main() -> int:
    ...
    for definition in definitions():
        ...
        WORKING.write_text(
            json.dumps({"schema": SCHEMA, "records": records}, indent=2, sort_keys=True)
            + "\n",
            encoding="utf-8",
        )
    ...
    report = {
        ...
        "contract": {
            ...
            "released_inputs": "V3 re-optimized near-onset and terminal right singular vectors",
            "coordinate_metric": "exact released V3 reference coordinate scales",
        ...
        "provenance": {
            ...
            "v3_evidence": v3nl.V3_EVIDENCE.relative_to(ROOT).as_posix(),
            "v3_evidence_sha256": v2.sha256(v3nl.V3_EVIDENCE),
            "v3_arrays": v3nl.V3_ARRAYS.relative_to(ROOT).as_posix(),
