...
$k^*=6.837\times10^3~\mathrm{m^{-1}}$ and the 1025-state map gives
$\mathcal G=6.29\times10^5$. Same-selector piecewise-frozen products
...
within its small-amplitude acceptance gates.  Retaining every resolvable
Fourier mode instead makes the continuation non-finite even after substep
refinement.  The evidence therefore validates finite-time linear selection
and low-mode consistency, but not complete nonlinear transport or
finite-amplitude saturation.
...
strict HCP-to-Bai analytical degeneration.  The open full-Fourier gate further
shows that finite-band linear selection alone does not regularize nonlinear
harmonic transfer. Complete generators, singular
